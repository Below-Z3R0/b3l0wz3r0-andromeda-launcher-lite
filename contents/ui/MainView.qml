...
Item {
 ...
 // signal  newTextQuery(string text)
  ...
  readonly property string textFont: plasmoid.configuration.useSystemFontSettings ? Kirigami.Theme.defaultFont : Kirigami.Theme.defaultFont.family
  ...
  Greeting {
    id: greeting
    visible: plasmoid.configuration.enableGreeting
